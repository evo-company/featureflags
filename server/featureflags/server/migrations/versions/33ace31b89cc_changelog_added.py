...
def upgrade():
    ...
    sa.Column('actions', postgresql.ARRAY(sa.Enum('ENABLE_FLAG', 'DISABLE_FLAG', 'ADD_CONDITION', 'DISABLE_CONDITION', 'RESET_FLAG', name='changelog_actions')), nullable=True),
    sa.ForeignKeyConstraint(['auth_user'], ['auth_user.id'], ),
